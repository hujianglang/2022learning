...
QT_MOC_LITERAL(1, 17, 19), // "onTitleBarDestroyed"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 14) // "showFullScreen"

    },
    "CFramelessWindow\0onTitleBarDestroyed\0"
    "\0showFullScreen"
};
...
void CFramelessWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CFramelessWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onTitleBarDestroyed(); break;
...
QT_INIT_METAOBJECT const QMetaObject CFramelessWindow::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_CFramelessWindow.data,
    qt_meta_data_CFramelessWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
